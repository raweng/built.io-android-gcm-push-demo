...
public class MainActivity extends Activity {
    ...
    private static final String APPLICATION_API_KEY = "YOUR_API_KEY";
    private BuiltInstallation installation;
	...
	private void sendRegistrationIdToBackend() {
        ...
        try
        {
            ...
            builtApplication = Built.application(context , APPLICATION_API_KEY);
            ...
            */
            ...
            installation.createInstallationInBackground(regid, null, new BuiltResultCallBack() {
                ...
                public void onCompletion(BuiltConstant.ResponseType responseType, BuiltError builtError) {
                    ...
                    if (builtError == null){
                        ...
                        Toast.makeText(MainActivity.this, "Installation created successfully...", Toast.LENGTH_SHORT).show();
                    }else {
                        Toast.makeText(MainActivity.this, "error :" + builtError.getErrorMessage(), Toast.LENGTH_SHORT).show();
                    }
