...
public class MainActivity extends Activity {
	...
	private void sendRegistrationIdToBackend() {
		installation = new BuiltInstallation();
		installation.createInstallation(regid, null, new BuiltResultCallBack() {
			@Override
			public void onSuccess() {
				Log.d(TAG, installation.toJSON().toString()); 	
			}
			...
			public void onError(BuiltError builtErrorObject) {
				...
				Log.d(TAG, builtErrorObject.getErrorMessage());
			}
